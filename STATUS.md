...
> Last updated: 2026-08-31 | PR MERGED: #19–#52, #54–#65, #67, #69–#71, #73, #75–#77, #79–#105 (#68, #74, #78 closed/superseded) — lihat tabel pointer di bawah. **PR #105 MERGED** (squash `0f07442`, 2026-08-31) — toast sukses submit; unlock tidak lagi hapus pilihan client (cuma reopen), reset destruktif dipisah ke endpoint/tombol/event realtime sendiri (`album:reset`); galeri pre-fill pilihan tersimpan dari server; 267/267 vitest; live browser E2E di preview PASSED sebelum merge (unlock-preserves, submit toast 200, reset clears + delivered-reset 409). **PR #106 OPEN** (`enhance/motion-click-progress-feedback`, 2026-08-31) — motion press-feedback + spinner progress untuk submit/lock/unlock/reset + badge-exit diperbaiki (`AnimatePresence`), konstanta bersama `src/lib/motion.ts`; 267/267 vitest; live DOM-measured di preview PASSED.
