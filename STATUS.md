...
> Last updated: 2026-07-23 | PR MERGED: **#19** admin dashboard, **#20** PIN rate-limit, **#21** direct-to-Sanity upload, **#22** Astro 5→6, **#23** impeccable CLI, **#25** junie review workflow, **#26** gallery-upload improvements, **#27** long-term audit improvements (CSP/HSTS + hybrid rendering + Upstash KV cache), **#28** admin login rate-limit (H-1), **#29** session revocation (M-1), **#30** Ably realtime album scoping (M-2), **#32** selection notes & gallery link improvements, **#33** Vercel Web Analytics, **#34** new-audit-2.md findings #1-#8,#10, **#35** new-audit-2.md #9,#11, **#36** mobile-first impeccable (share buttons visible + upload responsive), **#37** gallery mobile-first adapt, **#38** UI/UX audit P1/P2 (landing/login/dashboard/upload), **#40** mode reorder foto eksplisit + fallback touch, **#41** CSP connect-src fix (*.ably.net), **#43** resize foto client-side sebelum upload, **#44** cross-agent memory bank guardrail, **#45** tooling config (code-review-graph/Letta/opencode), **#46** pindahkan narasi task/PR ke ~/.junie/tasks/, **#47** sync status doc-only, **#48** REVIEW.md accuracy pass + z-index token rule, **#49** sync status doc-only, **#50** audit #3 — 7 temuan valid diperbaiki (Ably leak, CSRF fail-closed, cache health counter, upload race/backoff/creds/mountedRef), **#51** sync status doc-only. Semua audit temuan ✅ FIXED. **PR terbuka: #52** (fix lightbox backdrop fade-in yang sempat menampilkan teks halaman di baliknya sesaat). Narasi lengkap tiap PR: `~/.junie/tasks/` (lokal, lihat bagian "Riwayat Task/PR" di bawah).
