...
> Last updated: 2026-08-31 | PR MERGED: #19–#52, #54–#65, #67, #69–#71, #73, #75–#77, #79–#104 (#68, #74, #78 closed/superseded) — lihat tabel pointer di bawah. **PR #105 OPEN** (`fix/submit-notice-preserve-selections`, 2026-08-31) — toast sukses submit; unlock tidak lagi hapus pilihan client (cuma reopen), reset destruktif dipisah ke endpoint/tombol/event realtime sendiri (`album:reset`); galeri pre-fill pilihan tersimpan dari server; 267/267 vitest, tsc/lint hijau; **live browser E2E di preview PASSED** (unlock-preserves, submit toast 200, reset clears + delivered-reset 409, semua toast verbatim — report PR #105).
